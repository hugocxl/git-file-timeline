...
const filenameRegex: LanguagePattern[] = [
...
export function getLanguage(filename: string): string {
  const match = filenameRegex.find((x) => x.regex.test(filename));
  return match?.lang ?? "javascript";
}
 ...
 */
export function loadLanguage(_lang: string): Promise<void> {
